...
<div class="row">
      <div class="medium-12 large-12 columns">
        ...
        <form action="{{ $modify == 1 ? route('update_client', [ 'client_id' => $client_id ]) : route('create_client') }}" method="post"> <!-- sin necesidad de un campo hide porque el client_id se envía directamente desde la action con la ruta -->
         {{ csrf_field() }} 
          <div class="medium-4  columns">
            <label>Title</label>
            <select name="title">
               @foreach( $datos as $title)
